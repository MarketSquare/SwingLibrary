...
public class ComponentExistenceResolver implements IComponentConditionResolver {
    ...
    public ComponentExistenceResolver(ArgumentParser<?> identifierParser) {
        this.identifierParser = identifierParser;
    }

    public boolean satisfiesCondition(String identifier) {
        try {
            identifierParser.parseArgument(identifier);

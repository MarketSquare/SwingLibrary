...
public class TimeoutName {
    ...
    public static final String J_MENU_OPERATOR_WAIT_POPUP_TIMEOUT = "JMenuOperator.WaitPopupTimeout";
    public static final String COMPONENT_OPERATOR_WAIT_COMPONENT_TIMEOUT = "ComponentOperator.WaitComponentTimeout";
    public static final String WINDOW_WAITER_WAIT_WINDOW_TIMEOUT = "WindowWaiter.WaitWindowTimeout";
    public static final String FRAME_WAITER_WAIT_FRAME_TIMEOUT = "FrameWaiter.WaitFrameTimeout";
    public static final String DIALOG_WAITER_WAIT_DIALOG_TIMEOUT = "DialogWaiter.WaitDialogTimeout";
    public static final String J_COMBO_BOX_OPERATOR_WAIT_LIST_TIMEOUT = "JComboBoxOperator.WaitListTimeout";
}
